...
<div id="collapse1" style="display:none">
    ...
    <code class="inlinecode">
        &lt;iframe width="350" height="140" src="<?php echo (Configure::read('isSsl') ? 'https' : 'http'); ?>://<?php echo $_SERVER['SERVER_NAME']; ?>/widgets/events?<span class="highlight">id=1234</span>"&gt;&lt;/iframe&gt;
    </code>
    ...
    <code class="inlinecode">
        &lt;iframe width="350" height="140" src="<?php echo (Configure::read('isSsl') ? 'https' : 'http'); ?>://<?php echo $_SERVER['SERVER_NAME']; ?>/widgets/events?id=<?php if(isset($wsuid)){ echo $wsuid; }else { echo '1234'; } ?>&<span class="highlight">num=2</span>&<span class="highlight">trunc=330px</span>"&gt;&lt;/iframe&gt;
    </code>
    ...
    <code class="inlinecode">
        &lt;iframe width="350" height="140" <span class="highlight">style="border:3px solid #000; background:#FFC;"</span> src="<?php echo (Configure::read('isSsl') ? 'https' : 'http'); ?>://<?php echo $_SERVER['SERVER_NAME']; ?>/widgets/events?id=<?php if(isset($wsuid)){ echo $wsuid; }else { echo '1234'; } ?>&num=2&trunc=330px"&gt;&lt;/iframe&gt;
    </code>
    <br /><br />
</div>