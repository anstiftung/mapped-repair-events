...
<div id="collapse3" class="collapse">
    ...
    <div class="docs-wrapper">
        ...
        <h3>Standard-Datenquelle auswählen</h3>
        <ul>
        ...
        <h3>Stadt / Bundesland / Kanton auswählen</h3>
        <ul>
    ...
    <div class="docs-wrapper">
        <h2><?php echo Configure::read('AppConfig.platformName'); ?>-Statistik</h2>
        <h3>Schnell-Einbindung</h3>
        ...
        <h3>Initiativen-Name ausblenden</h3>
        <ul>
        ...
        <h3>Datums-Filter</h3>
        <ul>
            <li>dateFrom: z.B. 01.01.2020</li>
            <li>dateTo: z.B. 31.12.2020</li>
        </ul>

        <code class="inlinecode">
            &lt;iframe frameborder="0" width="100%" height="700" src="<?php echo Configure::read('AppConfig.serverName'); ?>/widgets/statistics-workshop/1234?<span class="highlight">dateFrom=01.01.2020&dateTo=31.12.2020</span>"&gt;&lt;/iframe&gt;
        </code>

        <h3>Umweltentlastung ausblenden</h3>
        <ul>
    ...
    <div class="docs-wrapper">
        <h2>Anzahl der verschiedenen Bereiche (Repariert / Reparabel / Nicht repariert / Gesamt) anzeigen</h2>
