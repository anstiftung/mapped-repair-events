...
<div class="admin edit">
    ...
    <?php
        ...
        echo $this->Form->fieldset(
            ...
            $this->Form->control('InfoSheets.device_age', ['div' => 'input', 'label' => 'Alter in Jahren:']).'<br />'.
    ...
    <?php
        echo $this->Form->fieldset(
            $this->Form->control('InfoSheets.defect_description', ['required' => true, 'type' => 'textarea', 'label' => 'Fehlerbeschreibung:', 'placeholder' => 'Helft mit einer genauen Fehlerbeschreibung, wiederkehrende Defekte herauszufinden und so Schwachstellen in der Konstruktion von Geräten zu identifizieren! Bitte keine persönlichen Daten in dieses Feld eintragen, wie z.B. E-Mail-Adressen oder Telefonnummern.', 'maxlength' => 1000]).
