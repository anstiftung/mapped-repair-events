       ...
       <?php
        ...
        foreach($events as $event) {
            ...
            echo '<div class="row">';
                ...
                echo $this->Form->control($i.'.uhrzeitstart', ['label' => __('Add Event: Start Time'), 'timeFormat' => 24]);
                echo $this->Form->control($i.'.uhrzeitend', ['label' => __('Add Event: End Time'), 'timeFormat' => 24]);
