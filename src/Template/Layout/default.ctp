...
<meta name="application-name" content="<?php echo (Configure::read('isSsl') ? 'https' : 'http'); ?>://<?php echo $_SERVER['SERVER_NAME']; ?>"/> 
<meta name="msapplication-tooltip" content="<?php echo (Configure::read('isSsl') ? 'https' : 'http'); ?>://<?php echo $_SERVER['SERVER_NAME']; ?>"/> 
<meta name="apple-mobile-web-app-title" content="<?php echo (Configure::read('isSsl') ? 'https' : 'http'); ?>://<?php echo $_SERVER['SERVER_NAME']; ?>"/> 
