...
class StringComponent extends Component
{
    ...
    public static function makeNoFollow(&$str, $relValue = 'nofollow'): string
    {
    ...
    public static function createConfirmationCode($email): string
    {
     ...
     */
    public static function hide_email($email, $class = '', $renderAsLink = true): string
    {
