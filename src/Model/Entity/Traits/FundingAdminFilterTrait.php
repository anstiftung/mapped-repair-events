...
trait FundingAdminFilterTrait {
    ...
    public static function getAdminFilterOptions(): array {
        return [
            ...
            'usageproof-pending' => 'VN: noch nicht begonnen',
            'usageproof-in-progress' => 'VN: in Bearbeitung',
            'usageproof-verified' => 'VN: von Admin bestätigt',
            'usageproof-rejected' => 'VN: von Admin beanstandet',
