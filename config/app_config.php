...
return [
    ...
    'isApiEnabled' => false,
    'useApiTokenAuthMiddleware' => true,
    'AppConfig' => [
        ...
        'status' => [APP_ON => 'aktiv', APP_OFF => 'inaktiv', APP_DELETED => 'gelöscht'],
        'approvalStatus' => [APP_ON => 'bestätigt', APP_OFF => 'unbestätigt', APP_DELETED => 'gelöscht'],
        'status2' => [APP_ON => 'aktiv', APP_OFF => 'inaktiv'],
        'yesno' => [0=>'nein',1=>'ja'],
        ...
        'fundingsEndDateNTime' => '2025-02-24 23:59:59',
